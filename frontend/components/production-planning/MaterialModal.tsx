// components/production-planning/MaterialModal.tsx
'use client';
...
import { ModalMode, CATEGORY_OPTIONS } from '@/types/production-planning';
...
const initialFormData: MaterialCreate = {
    material_code: '',
    material_name: '',
    material_type: '',
    category: 'raw',
...
export default function MaterialModal({
    ...
    const [formData, setFormData] = useState<MaterialCreate>(initialFormData);
        ...
        <Dialog open={open} onClose={onClose} maxWidth="md" fullWidth>
            ...
            <DialogContent dividers>
                <Grid container spacing={2}>
                    ...
                    {/* Stock Status Display (View Mode Only) */}
                    {isViewMode && material && (
                        <>
                            <Grid item xs={12}>
                                <Divider sx={{ my: 1 }} />
                    ...
                    {/* System Information Display (View Mode Only) */}
                    {isViewMode && material && (
                        <>
                            <Grid item xs={12}>
                                <Divider sx={{ my: 1 }} />
