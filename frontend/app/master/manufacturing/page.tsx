...
export default function ManufacturingPage() {
    ...
    type PlanSearchParams = { search?: string; status?: string };
    ...
    const {
        ...
        fetch: fetchPlans,
    } = useFetchData<ProductionPlan[], PlanSearchParams>({
        fetchFn: useCallback((params?: PlanSearchParams) => productionPlanApi.getPlans(params), []),
        ...
        <AuthGuard>
            <Sidebar>
                <Box sx={{ width: '100%' }}>
                    ...
                    <Tabs value={tabValue} onChange={handleTabChange} aria-label="manufacturing tabs" sx={{ mb: 2 }}>
